          ...
          <div className="relative p-8 lg:p-12 rounded-3xl bg-gradient-to-br from-foreground to-foreground/90 text-primary-foreground">
            ...
            <div className="relative z-10">
              <p className="text-lg lg:text-xl leading-relaxed mb-8">
                ...
                Este documento consolida nossa visão estratégica, nossa forma de atuar e os resultados alcançados 
                em um período marcado por desafios relevantes, mas também por realizações significativas."
              </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-foreground/60">Construcap CCPS Engenharia e Comércio S.A.</p>
                </div>
              </div>
            </div>
