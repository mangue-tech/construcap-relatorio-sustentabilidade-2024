...
const griData: GRIItem[] = [
  ...
  { 
    ...
    section: "Quem Somos",
    response: "Grupo Construcap e suas controladas: Urbia, Minas Arena, Inova Saúde e Ambicap.",
    link: "/quem-somos"
  },
  { 
    code: "GRI 2-3", 
  ...
  { 
    ...
    section: "Quem Somos",
    response: "Atuação em infraestrutura pesada, construção industrial, edificações, gestão de parques, hospitais e soluções ambientais.",
    link: "/quem-somos"
  },
  { 
    code: "GRI 2-7", 
    ...
    response: "Colaboradores distribuídos nas cinco unidades de negócio: Construcap Engenharia, Inova Saúde, Urbia, Minas Arena e Ambicap.",
  ...
  { 
    ...
    section: "Estratégia e Governança",
    response: "Conselheiros eleitos em Assembleia Geral com critérios de experiência setorial e competências complementares.",
    link: "/governanca"
  },
  { 
    code: "GRI 2-11", 
  ...
  { 
    ...
    response: "Mapeamento de grupos de stakeholders com engajamento contínuo via canais específicos e pesquisa de materialidade.",
    link: "/materialidade"
  },
  { 
    code: "GRI 2-30", 
  ...
  { 
    ...
    section: "Materialidade e Stakeholders",
    response: "Temas materiais incluem: Saúde e Segurança, Mudanças Climáticas, Gestão de Resíduos, Ética e Integridade, entre outros.",
    link: "/materialidade"
  },
  { 
    code: "GRI 3-3", 
  ...
  { 
    ...
    response: "Valor econômico gerado e distribuído entre colaboradores, fornecedores, governo, investidores e comunidades.",
  ...
  { 
    ...
    section: "Desempenho Social",
    response: "Plano de saúde, plano odontológico, seguro de vida, previdência privada, PLR, vale-alimentação, auxílio-creche.",
    link: "/desempenho-social"
  },
  { 
    code: "GRI 401-3", 
  ...
  { 
    ...
    response: "Obras com diagnóstico social e canais de comunicação com comunidades (Alô Construcap, reuniões comunitárias).",
    link: "/comunidades"
  },
  { 
    code: "GRI 413-2", 
