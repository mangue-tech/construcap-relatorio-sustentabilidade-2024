            ...
            <div className="flex-1 bg-card rounded-2xl border border-border p-8 lg:p-12">
              ...
              <div className="prose prose-lg max-w-none text-foreground">
                <p className="text-lg leading-relaxed mb-6 first-letter:text-4xl first-letter:font-bold first-letter:text-primary first-letter:mr-1 first-letter:float-left">
                  ...
                  período marcado por desafios relevantes, mas também por realizações significativas em nossos negócios
                  de construção, concessões, gestão de parques, saúde e serviços.
                </p>
                ...
                <p className="leading-relaxed mb-6">
                  ...
                  presentes. No setor de concessões e parques, por meio da <strong>Urbia</strong>, fortalecemos a gestão
                  sustentável dos espaços naturais e turísticos sob nossa responsabilidade, ampliando a oferta de
                  infraestrutura, serviços, acessibilidade e experiências de qualidade para milhões de visitantes. Em
                  saúde, com as unidades da <strong>Inova</strong>, seguimos operando estruturas hospitalares complexas
                  com foco em eficiência, desempenho assistencial e impacto social positivo. Na
                  <strong> Minas Arena</strong>, reforçamos o compromisso com a gestão responsável de um dos principais
                  equipamentos esportivos do país, que recebe eventos de grande exposição pública e relevância
                  econômica.
                </p>

                <p className="leading-relaxed mb-6">
                  Reconhecemos que nossa atuação só é possível graças ao empenho de um time altamente comprometido, que
                  reúne milhares de profissionais em diferentes regiões do Brasil.
                </p>
                ...
                <p className="leading-relaxed mb-6">
                  <strong>Infraestrutura é motor de desenvolvimento nacional</strong>, e acreditamos no papel da
                  Construcap como agente de geração de valor compartilhado. Continuaremos investindo em governança,
                  inovação, eficiência e sustentabilidade, alinhados às expectativas de nossos clientes, parceiros,
