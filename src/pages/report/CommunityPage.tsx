...
const CommunityPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="pt-24 pb-16 bg-gradient-to-b from-teal-950/20 to-background">
        <div className="container mx-auto px-6">
          <AnimatedSection>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Relacionamento com Comunidades</h1>
      ...
      {/* Impact Mitigation */}
      <section className="py-16 bg-teal-950/10">
        <div className="container mx-auto px-6">
          <AnimatedSection>
