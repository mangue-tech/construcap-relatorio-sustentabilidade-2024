...
const emissionsByScope = [
  { name: "Escopo 1", value: 15116.357, percentage: 45.1, color: "hsl(var(--primary))", description: "Emissões diretas" },
  { name: "Escopo 2", value: 1617.679, percentage: 4.8, color: "hsl(221, 83%, 53%)", description: "Energia elétrica adquirida" },
...
const scope3Categories = [
  { category: "Categoria 1 – Bens e serviços adquiridos", value: 9231.820, percentage: 54.9, description: "concreto e aço como principais insumos" },
  { category: "Categoria 6 – Viagens a negócios", value: 5868.542, percentage: 34.9, description: "viagens aéreas e hospedagens corporativas" },
  { category: "Categoria 5 – Resíduos gerados na operação", value: 1716.419, percentage: 10.2, description: "4.051,36 t enviados para aterro, incineração e recicladores" },
];

// Emissões por unidade de negócio
const emissionsByUnit = [
  { unit: "Construcap Construção Civil", value: 23029.790, percentage: 68.6 },
...
const inovaWater = {
  ...
  units: [
    ...
    { hospital: "Hospital Regional de Sorocaba (HSOR)", consumption: 34.040 },
...
const wasteData = {
  ...
  breakdown: [
    ...
    { destination: "Incineração", weight: 1830.268, emissions: 326.140, biogenic: 1386.442 },
    ...
    <ReportLayout>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <AnimatedSection>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                A gestão ambiental do Grupo Construcap é estruturada para garantir que suas operações 
                em engenharia pesada, gestão hospitalar, concessões de parques naturais e urbanos e 
                administração de arenas esportivas ocorram de forma responsável.
              </p>
            </AnimatedSection>
          </div>
        </div>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              pesada, gestão hospitalar, concessões de parques naturais e urbanos e administração de arenas 
              esportivas ocorram de forma responsável, com foco em prevenção de impactos, uso eficiente de 
              recursos, conformidade regulatória e mitigação de emissões de gases de efeito estufa (GEE).
            </p>
            <p className="text-muted-foreground">
              Em 2024, um marco relevante foi a conclusão do primeiro inventário corporativo de emissões de GEE, 
              cobrindo Escopos 1, 2 e 3 para todo o Grupo, além da consolidação de dados ambientais de 
              unidades-chave como Inova Saúde e Minas Arena, que reforçam a maturidade da agenda ambiental 
              e climática da Construcap.
            </p>
          </div>
        </AnimatedSection>
      </section>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            <p className="text-muted-foreground mb-6">
              ...
              materiais de construção e insumos hospitalares. No recorte de 2024, apenas na Construcap Construção 
              Civil foram consumidos volumes significativos de materiais com impacto relevante na pegada de carbono.
            </p>
            ...
            <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
              <p className="text-sm">
                <strong className="text-foreground">Total Escopo 3 - Categoria 1:</strong> {materialsData.totalEmissions.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂e 
                em bens e serviços adquiridos. Esses números evidenciam que parte importante da pegada de carbono 
                do Grupo está "incorporada" nos materiais utilizados, o que reforça a necessidade de diálogo com 
                fornecedores, especificação de materiais de menor intensidade de carbono, otimização de projetos 
                e maior uso de soluções de engenharia de baixo carbono.
              </p>
            </div>
          </div>
        </AnimatedSection>
      ...
      <section className="py-12">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            <p className="text-muted-foreground mb-6">
              O consumo energético do Grupo reflete o perfil das diferentes operações. Em 2024, o consumo total 
              de eletricidade das empresas da Construcap foi de <strong className="text-foreground">32.777.724,33 kWh</strong>, 
              resultando em <strong className="text-foreground">1.795,075 tCO₂e</strong> de emissões associadas ao 
              Escopo 2, considerando o fator de emissão oficial do SIN/MCTI.
            </p>
          </div>
        </AnimatedSection>
                ...
                <div key={hospital.hospital} className="p-4 rounded-xl bg-secondary/50">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-yellow-500 font-bold">{hospital.emissions.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂e</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-6 mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              ...
              energética e melhoria da qualidade luminosa, reforçando a posição do Mineirão como referência em 
              gestão energética de grandes equipamentos urbanos.
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-secondary/30 rounded-2xl p-6">
            <p className="text-sm text-muted-foreground">
              ...
              substituição gradual de equipamentos menos eficientes e uso de LED em áreas comuns, ainda que 
              os dados detalhados de cada canteiro não estejam consolidados neste ciclo.
            </p>
          </div>
        </AnimatedSection>
      </section>
      ...
      <section className="py-12 -mx-6 lg:-mx-8 px-6 lg:px-8 bg-blue-950/10">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-6 mb-6">
            ...
            <p className="text-muted-foreground mb-4">
              Em 2024, a Inova Saúde monitorou o consumo de água em suas unidades, totalizando <strong className="text-foreground">{inovaWater.total.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} megalitros (ML)</strong>. 
              As fontes são predominantemente de abastecimento público, com o HSJC incorporando também água de captação de chuva.
            </p>
            <div className="grid sm:grid-cols-3 gap-4 mb-4">
              {inovaWater.units.map((unit) => (
                <div key={unit.hospital} className="p-4 rounded-xl bg-blue-500/10 text-center">
                  <p className="text-2xl font-bold text-blue-500">{unit.consumption.toLocaleString('pt-BR', { minimumFractionDigits: 3 })}</p>
            ...
            <div className="p-4 rounded-xl bg-secondary/50">
              <p className="text-sm text-muted-foreground">
                O tratamento de efluentes é realizado para cumprimento integral do Artigo 19-A do Regulamento da 
                Lei Estadual nº 997/76 (Decreto nº 8.468/76), garantindo que parâmetros de poluentes se mantenham 
                dentro dos limites legais antes do descarte, com base em análises periódicas e registros de 
                hidrômetros e de qualidade de efluentes.
              </p>
            </div>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-6 mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              A água de reúso é utilizada em sanitários e irrigação do gramado. Essa estratégia diminui a pressão 
              sobre a rede pública, reduz custos operacionais e fortalece a resiliência hídrica do estádio frente 
              a cenários de escassez.
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-6">
            ...
            <p className="text-muted-foreground">
              ...
              naturais e urbanos, o foco recai sobre a proteção de nascentes, drenagem ecológica e conservação de 
              corpos hídricos.
            </p>
          </div>
        </AnimatedSection>
      ...
      <section className="py-12">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8">
            <p className="text-muted-foreground mb-6">
              Por meio da Urbia e da Ambicap, o Grupo é responsável pela gestão de parques estaduais, urbanos e 
              áreas de conservação de alta relevância, incluindo Jericoacoara, Cânions Verdes, parques estaduais 
              em São Paulo (Cantareira, Alberto Löfgren, entre outros) e parques urbanos como o Ibirapuera e 
              outros em São Paulo.
            </p>
            ...
            <p className="text-sm text-muted-foreground">
              Em alinhamento com planos de manejo e diretrizes dos órgãos ambientais, as equipes ambientais 
              implementam todas essas ações visando a conservação da biodiversidade e a minimização de impactos.
            </p>
          </div>
        </AnimatedSection>
      </section>
      ...
      <section className="py-12 -mx-6 lg:-mx-8 px-6 lg:px-8 bg-secondary/30">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            <p className="text-muted-foreground mb-4">
              Em 2024, o Grupo Construcap publicou seu primeiro inventário consolidado de emissões, elaborado 
              pela Mangue Tech, com base no Programa Brasileiro GHG Protocol, no GHG Protocol Corporate Standard 
              e na ABNT NBR ISO 14064-1, adotando o critério de controle operacional e incluindo empresas com 
        ...
        <AnimatedSection>
          <div className="text-center p-8 bg-card rounded-2xl border border-border mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              + {emissionsData.biogenic.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂ de emissões biogênicas
            </p>
          </div>
        </AnimatedSection>
                ...
                {scope1Details.map((item) => (
                  <div key={item.source} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium w-28 text-right">{item.value.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} t</span>
                    </div>
                  </div>
                ))}
              </div>
              <p className="text-xs text-muted-foreground mt-4">
                A predominância da combustão móvel reflete o uso intensivo de diesel e outros combustíveis em 
                frota operacional e equipamentos de obras e operações distribuídas territorialmente.
              </p>
            </div>
          </AnimatedSection>
                ...
                {scope3Categories.map((item) => (
                  <div key={item.category} className="p-3 rounded-lg bg-secondary/50">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-bold text-emerald-500">{item.value.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} t</span>
                    </div>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-6">
                ...
                <div key={item.unit}>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold text-primary">{item.value.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂e</span>
                    </div>
                  </div>
            ...
            <p className="text-sm text-muted-foreground mt-4">
              Esse perfil confirma as obras de engenharia pesada e a operação hospitalar como os principais 
              vetores de emissões e, ao mesmo tempo, os principais focos de ações de descarbonização.
            </p>
          </div>
        </AnimatedSection>
      </section>
      ...
      <section className="py-12">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            <p className="text-muted-foreground mb-6">
              Em 2024, a geração de resíduos do Grupo totalizou <strong className="text-foreground">{wasteData.totalGenerated.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} toneladas</strong>, 
              com emissões associadas de <strong className="text-foreground">{wasteData.totalEmissions.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂e</strong> e 
              <strong className="text-foreground"> {wasteData.biogenicEmissions.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂</strong> biogênicas.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              {wasteData.breakdown.map((item) => (
                <div key={item.destination} className="p-4 rounded-xl bg-secondary/50 text-center">
                  ...
                  <p className="text-2xl font-bold text-purple-500">{item.weight.toLocaleString('pt-BR', { minimumFractionDigits: 3 })}</p>
                  <p className="text-xs text-muted-foreground">toneladas</p>
                  <p className="text-sm text-muted-foreground mt-1">{item.emissions.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂e</p>
                  {item.biogenic && (
                    <p className="text-xs text-muted-foreground">+ {item.biogenic.toLocaleString('pt-BR', { minimumFractionDigits: 3 })} tCO₂ biog.</p>
                  )}
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Seguem planos de gerenciamento de resíduos de serviços de saúde (PGRSS), em conformidade com 
                  ANVISA e CONAMA, com rastreabilidade via MTR e CDF.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Aplicam segregação por classes, aumento de reciclagem de resíduos de construção e destinação 
      ...
      <section className="py-12 -mx-6 lg:-mx-8 px-6 lg:px-8 bg-secondary/30">
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            <p className="text-muted-foreground mb-6">
              O Grupo Construcap conta com reconhecimentos ambientais que reforçam sua capacidade de operar 
              ativos complexos dentro de padrões internacionais de sustentabilidade.
            </p>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {certifications.map((cert, index) => (
                <div key={cert.name} className="p-4 rounded-xl bg-secondary/50 border border-border hover:border-primary/50 transition-colors">
        ...
        <AnimatedSection>
          <div className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground rounded-2xl p-8">
            ...
            <p className="text-primary-foreground/90 mb-6">
              O Estádio Governador Magalhães Pinto – Mineirão consolidou-se como referência internacional em 
              construção e operação sustentável. Em 2014, tornou-se o <strong>primeiro estádio do mundo</strong> a 
              obter a certificação LEED Platinum, emitida pelo U.S. Green Building Council, pela excelência em 
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8">
            <p className="text-muted-foreground mb-6">
              ...
              normas sanitárias e regulatórias, além de requisitos específicos de concessões em parques, arenas 
              e hospitais.
            </p>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Auditorias internas e externas, sistemas de gestão certificados e monitoramento de indicadores 
              asseguram correção tempestiva de desvios e melhoria contínua do desempenho ambiental.
            </p>
          </div>
        </AnimatedSection>
      </section>
