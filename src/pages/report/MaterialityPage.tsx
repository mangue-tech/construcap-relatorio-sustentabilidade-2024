...
const materialTopics = [
  { 
    ...
    description: "Prevenção de acidentes, cultura de segurança, capacitação e gestão de riscos ocupacionais em todas as operações do Grupo.",
    context: "Relevante para obras, unidades de saúde, parques e arenas. Abrange colaboradores diretos, terceiros e visitantes.",
    icon: Heart, 
    color: "bg-rose-500" 
  },
  { 
    ...
    description: "Mecanismos de compliance, combate à corrupção, canal de denúncias e controles internos aplicáveis a todas as unidades.",
    context: "Requisito de clientes públicos e privados, além de exigência do ambiente regulatório em que a empresa atua.",
    icon: Shield, 
    color: "bg-amber-500" 
  },
  { 
    ...
    description: "Gestão de resíduos, uso eficiente de recursos, conformidade ambiental, certificações ambientais e iniciativas de descarbonização.",
  ...
  { 
    ...
    description: "Inventário de emissões (Escopos 1, 2 e 3), metas de redução, estratégias de mitigação e compensação de carbono.",
  ...
  { 
    ...
    description: "Impactos sociais de obras, gestão de áreas públicas, engajamento comunitário, investimento social privado e inclusão social.",
  ...
  { 
    ...
    description: "Padrões técnicos, engenharia aplicada, eficiência operacional, adoção de novas tecnologias e práticas de melhoria contínua.",
  ...
  { 
    ...
    description: "Conservação ambiental, manejo de trilhas, restauração ecológica, educação ambiental e proteção da biodiversidade.",
  ...
  { 
    ...
    description: "Infraestrutura acessível, qualidade de atendimento, inclusão de PCD e qualidade de serviços em equipamentos públicos.",
    context: "Relevante para parques, arenas e hospitais, onde a experiência do público é central para o sucesso da operação.",
    icon: Briefcase, 
    color: "bg-indigo-500" 
  },
  { 
    ...
    description: "Qualificação de fornecedores, due diligence, requisitos socioambientais, monitoramento e desenvolvimento de parceiros.",
  ...
  { 
    ...
    description: "Adaptação a eventos extremos, continuidade operacional, planejamento de contingência e resiliência de infraestrutura.",
    context: "Relevante devido ao aumento de eventos extremos e impactos sobre continuidade operacional em todas as unidades.",
    icon: Globe, 
    color: "bg-red-500" 
  },
];
...
const stakeholders = [
  ...
  },
  {
    ...
    description: "Governos, empresas privadas e instituições que contratam serviços de engenharia, concessão ou gestão.",
    engagement: [
...
const methodologySteps = [
  { 
    step: 1, 
    title: "Identificação", 
    description: "Mapeamento de temas potencialmente relevantes a partir de diretrizes GRI, requisitos setoriais, análises de risco e benchmarking.",
    details: [
  ...
  { 
    ...
    description: "Avaliação do impacto dos temas sobre estratégia, operações, riscos, continuidade e reputação da organização.",
    details: [
  ...
  { 
    step: 3, 
    title: "Engajamento", 
    description: "Consideração das expectativas e interesses de stakeholders estratégicos por meio de mecanismos de escuta.",
    details: [
...
const materialityUsage = [
  { title: "Planos ESG", description: "Orientação para elaboração dos planos de ação ESG de cada unidade de negócio.", icon: Layers },
  { title: "Políticas Corporativas", description: "Definição e atualização de políticas alinhadas aos temas materiais.", icon: FileSearch },
  { title: "Investimentos", description: "Priorização de investimentos em projetos de maior impacto ESG.", icon: TrendingUp },
  { title: "Gestão de Riscos", description: "Integração dos temas materiais à matriz de riscos corporativos.", icon: Shield },
  { title: "Tomada de Decisão", description: "Subsídio para decisões operacionais e estratégicas.", icon: Settings },
  { title: "Métricas e Indicadores", description: "Definição de KPIs para monitoramento do desempenho ESG.", icon: BarChart3 },
  { title: "Metas Climáticas", description: "Estruturação de metas de redução de emissões e eficiência.", icon: Target },
  { title: "Transparência", description: "Base para prestação de contas e comunicação com stakeholders.", icon: BookOpen },
];

// 6.5 - Critérios de Priorização
const prioritizationCriteria = [
  { criterion: "Magnitude do Impacto", description: "Escala e intensidade dos efeitos econômicos, ambientais e sociais do tema." },
  { criterion: "Probabilidade de Ocorrência", description: "Frequência e previsibilidade dos eventos relacionados ao tema." },
  { criterion: "Reversibilidade", description: "Possibilidade de remediação ou recuperação dos impactos gerados." },
  { criterion: "Relevância para Stakeholders", description: "Importância atribuída ao tema pelos principais grupos de interesse." },
  { criterion: "Alinhamento Estratégico", description: "Conexão do tema com a estratégia e os valores do Grupo Construcap." },
  { criterion: "Requisitos Regulatórios", description: "Existência de obrigações legais ou normativas relacionadas ao tema." },
];
    ...
    <ReportLayout>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <AnimatedSection>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                ...
                nossa capacidade de criar valor, considerando os impactos sobre pessoas, meio ambiente 
                e economia, além das expectativas dos stakeholders.
              </p>
            </AnimatedSection>
          </div>
        </div>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8">
            ...
            <p className="text-muted-foreground mb-4">
              O Grupo Construcap adota uma abordagem estruturada para definição de seus temas materiais, 
              seguindo as diretrizes do GRI 3: Material Topics 2021. O processo considera tanto os 
              impactos reais e potenciais das operações quanto as expectativas dos principais 
              grupos de interesse.
            </p>
            <p className="text-muted-foreground">
              A análise de materialidade é revisada periodicamente para garantir que os temas 
              priorizados reflitam a evolução do contexto de negócio, as mudanças regulatórias 
              e as novas demandas de stakeholders. O resultado orienta a estratégia ESG, a 
              definição de indicadores e a elaboração deste relatório.
            </p>
          </div>
        </AnimatedSection>
      </section>
      ...
      <section className="py-12">
        <AnimatedSection>
          ...
          <p className="text-muted-foreground mb-8">
            A priorização dos temas materiais considera múltiplos critérios que permitem avaliar 
            a relevância de cada tema para o Grupo e seus stakeholders.
          </p>
        </AnimatedSection>
      ...
      <section className="py-12 -mx-6 lg:-mx-8 px-6 lg:px-8 bg-secondary/30">
        <AnimatedSection>
          ...
          <p className="text-muted-foreground mb-8 max-w-4xl">
            O Grupo Construcap mantém relacionamento ativo com diversos grupos de stakeholders, 
            utilizando mecanismos específicos de engajamento para cada público. Esse diálogo 
            contínuo alimenta o processo de materialidade e orienta a gestão de impactos.
          </p>
        </AnimatedSection>
      ...
      <section className="py-12">
        <AnimatedSection>
          ...
          <p className="text-muted-foreground mb-8">
            O processo de materialidade consolidou um conjunto de 10 temas materiais que refletem 
            a relevância estratégica e operacional do Grupo Construcap, considerando os impactos 
            sobre economia, meio ambiente e sociedade.
          </p>
        </AnimatedSection>
      ...
      <section className="py-12 -mx-6 lg:-mx-8 px-6 lg:px-8 bg-indigo-950/10">
        <AnimatedSection>
          ...
          <p className="text-muted-foreground mb-8 max-w-4xl">
            Os temas materiais não são apenas reportados — eles orientam decisões estratégicas 
            e operacionais em todas as unidades do Grupo Construcap.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="bg-card rounded-2xl border border-border p-8">
            ...
            <p className="text-muted-foreground mb-6">
              Cada tema material identificado é abordado em seções específicas deste relatório, 
              com indicadores, metas e iniciativas relacionadas. A estrutura do relatório reflete 
              a priorização definida pela matriz de materialidade.
            </p>
