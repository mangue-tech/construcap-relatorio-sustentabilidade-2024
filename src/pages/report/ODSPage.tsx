      ...
      <div className="space-y-12">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
            O Grupo Construcap contribui ativamente para a Agenda 2030 das Nações Unidas, 
            alinhando suas operações e estratégias aos Objetivos de Desenvolvimento Sustentável.
          </p>
        </section>
