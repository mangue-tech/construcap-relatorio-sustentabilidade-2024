...
const odsData = [
  {
    ...
    color: "#4C9F38",
    items: [
      "Operação de três unidades hospitalares públicas pela Inova Saúde, Hospital da Mulher, Hospital Regional de Sorocaba e Hospital Regional de São José dos Campos 'Dr. Rubens Savastano'",
