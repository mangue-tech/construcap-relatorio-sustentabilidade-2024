      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            A Urbia reúne as operações de gestão de parques do Grupo Construcap, atuando em parques urbanos 
            de grande relevância e em unidades de conservação naturais de alto valor ecológico. No conjunto 
            de concessões, a Urbia é responsável pela administração de áreas que somam aproximadamente 
            <strong> 123 mil hectares</strong>, abrangendo parques urbanos, áreas de mata atlântica e parques 
            nacionais, com cerca de <strong>20 milhões de visitas anuais</strong>, consolidando-se como um dos 
            maiores operadores privados de parques e atrativos naturais do país (GRI 304-1, 203-1).
          </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                ...
                permanentes e programação voltada a escolas da rede pública, com foco em astronomia, ciência e 
                meio ambiente (GRI 413-1, 404-2).
              </p>
              <p className="text-muted-foreground">
                Também são mantidas atividades de música e cultura em espaços públicos, com destaque para 
                <strong> 38 apresentações da Escola de Música do Ibirapuera</strong>, que fortalece a inclusão 
                social por meio da formação musical e da democratização do acesso à cultura.
              </p>
